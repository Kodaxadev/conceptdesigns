...
export const concepts: Concept[] = [
  {
    ...
    heroImage: '/assets/concepts/split-flap/frame-soul-104.png',
    detailImage: '/assets/concepts/split-flap/frame-soul-104.png',
    artifactHref: '/assets/concepts/split-flap/splitflap-soul-board.glb',
